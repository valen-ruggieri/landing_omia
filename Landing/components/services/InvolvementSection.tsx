    ...
    <section className="relative px-4 py-20 text-white lg:py-24">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.03]">
          <div className="relative min-h-[32rem] w-full sm:aspect-[16/9] sm:min-h-0">
            <Image
              ...
              className="object-cover object-[center_60%] scale-[1.22] sm:object-center sm:scale-100"
            />

            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(139,92,246,0.22),transparent_28%),linear-gradient(180deg,rgba(7,11,22,0.92)_0%,rgba(7,11,22,0.72)_26%,rgba(7,11,22,0.28)_48%,rgba(7,11,22,0.48)_100%)]" />

            <div className="absolute inset-x-0 top-0 z-10 px-5 pt-8 text-center sm:px-10 sm:pt-10">
              <h2 className="text-[2.5rem] tracking-tighter text-white termina-light sm:text-4xl md:text-5xl lg:text-6xl">
                Como nos{' '}
