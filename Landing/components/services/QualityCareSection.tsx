      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-[2rem] border border-emerald-300/10 bg-[#081312]">
          ...
          <div className="relative z-10 flex min-h-[720px] flex-col px-6 py-8 sm:px-8 sm:py-10 lg:min-h-[620px] lg:px-10 lg:py-10 xl:min-h-[660px] xl:px-12 xl:py-12">
            <div className="mx-auto mb-10 max-w-7xl sm:mb-14 lg:mb-20">
            ...
            <div className="mt-8 flex flex-1 items-start lg:mt-10 lg:items-end">
                ...
                {qualityFocus.map((item, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      viewport={{ once: true, amount: 0.2 }}
                      transition={{ duration: 0.25, delay: index * 0.03 }}
                      className={`rounded-[0.95rem] border ${accent.border} bg-black/18 px-3.5 py-3 backdrop-blur-[6px]`}
                    >
                      <div className="flex items-center gap-2.5 text-left">
                        <Icon className={`h-[1rem] w-[1rem] shrink-0 ${accent.icon}`} />
                        <p className="text-[0.9rem] leading-snug text-white/92">{item.label}</p>
                      </div>
                    </motion.div>
                  );
                })}
